...
def send_pitch_materials(notes, client):
    """
...
def random_walk_only_new(num_chords_walked, neo_rweb, client, octave=None, time_interval=None):
    """
    ...
    for chord in chords:
        ...
        send_pitch_materials(generate_pitch_materials(neo_rweb, octave, chord), client)
...
if __name__ == "__main__":
    ...
    random_walk_only_new(3, web, client, time_interval=12)
