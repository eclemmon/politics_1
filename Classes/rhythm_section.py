    ...
    def __init__(self, meter: Meter, option: int = 2):
        ...
        if option == 1:
            ...
            self.midi_note_duration_arrays = [
                [0.25, '/r', 0.25] + rr(3) + nr(2) + ['/r'] + nr(3) + rr(2) + [0.25, '/r', 0.25] + ['/r', 0.25] + rr(3)
                + nr(2) + ['/r', 0.25] + rr(4) + [0.25, '/r', 0.25, '/r', 0.25] + rr(3) + nr(2) + ['/r', 0.25] + rr(5) +
                nr(2) + ['/r', 0.25] + rr(3) + [0.25] + rr(2) + nr(2) + ['/r', 0.25] + rr(3),
